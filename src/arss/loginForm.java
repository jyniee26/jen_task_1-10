...
public class loginForm extends javax.swing.JFrame {
    ...
    try {
        ...
        if (resultSet.next()) {
            ...
            System.out.println("Database password: " + hashedPass);
            System.out.println("Hashed input password: " + rehashedPass);
        ...
        ex.printStackTrace();
        return false;  // Return false on any error (e.g., database connection or password hashing issues)
    }
}
    ...
    private void initComponents() {
        ...
        jPanel3.add(login, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 270, 70, 30));
        ...
        jLabel2.setFont(new java.awt.Font("NSimSun", 3, 14)); // NOI18N
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, 180, -1));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 620, 370));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 620, 370));
